...
def load_filenames(data_dir):
    filepath = data_dir + '/filenames_flying_2682.pickle'
...
def convert_birds_dataset_pickle(inpath, set):
    ...
    print('Saving to {}'.format('Data/birds/{}/sketches_flying_2682.pickle'.format(set)))
    pickle.dump(sketches, open('Data/birds/{}/sketches_flying_2682.pickle'.format(set), 'wb'))
    pickle.dump(ids, open('Data/birds/{}/class_info_flying_2682.pickle'.format(set), 'wb'))
